<template>
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      <g>
        <path d="M0,0 L256,0 L256,256 L0,256 L0,0 Z" :style="fillStyle(0)"></path>
        <path
...
const defaultColors = ['#F7DF1E', '#000000'];
const whiteColors = ['#ffffff', '#FFBA00'];
const fillStyle = (index: number) => {
  return props.color === 'white' ? { fill: whiteColors[index] } : { fill: defaultColors[index] };
};
</script>
